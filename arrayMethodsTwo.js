...
// CODE HERE
let copyNumbers = numbers.map((element) => element/2)
...
fruits.forEach((fruit, index) => {
  ...
  } else console.log(`The fruit with index ${index} is neither apple or orange.`)
})
...
// CODE HERE
let foodRice = foods.filter((rice) => {
