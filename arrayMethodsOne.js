...
// CODE HERE
// let orderTotals = orders.reduce((acc, curr) => acc + curr).map(element => element.price * (1 + element.tax))
// console.log(orderTotals)
const pricesWithTax = orders.map((element) => {
  return (element.price * (1 + element.tax))
})

// let orderTotals = pricesWithTax.reduce((acc, curr) => acc + curr)
// console.log(orderTotals)
...
console.log(isBob)
// console.log(isBob)
// let bobsTotal = isBob.reduce((total, current) => total + current.price)
// console.log(bobsTotal)